...
/*
  ...
  passed to your function, nums is possibly left rotated at an unknown index k (1 <= k < nums.length)
...
-104 <= target <= 104
*/
public class SearchElementInRotatedArr {
    public static void main(String[] args) {
        SearchElementInRotatedArr obj=new SearchElementInRotatedArr();
